...
class ResolveDID(DIDResolutionMessage):
    ...
    async def resolve_did(context: RequestContext, did: str) -> dict:
        ...
        did_doc, resolver_metadata = await resolver.resolve(context.profile, did)
        return did_doc.serialize(), resolver_metadata
    ...
    async def handle(self, context: RequestContext, responder: BaseResponder):
        ...
        try:
            did_document, resolver_metadata\
                = await self.resolve_did(context, context.message.did)
