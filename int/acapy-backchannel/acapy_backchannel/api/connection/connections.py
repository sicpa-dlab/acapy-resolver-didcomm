...
from ...models.connections_state import ConnectionsState
from ...models.connections_their_role import ConnectionsTheirRole
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, ConnectionsState] = UNSET,
    their_did: Union[Unset, str] = UNSET,
    their_role: Union[Unset, ConnectionsTheirRole] = UNSET,
) -> Dict[str, Any]:
