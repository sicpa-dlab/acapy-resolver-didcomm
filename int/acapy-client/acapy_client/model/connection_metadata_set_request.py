...
class ConnectionMetadataSetRequest(ModelNormal):
    ...
    def __init__(self, metadata, *args, **kwargs):  # noqa: E501
        ...
        Args:
            metadata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Dictionary of metadata to set for connection.
