...
def lazy_import():
    ...
    globals()['IndyPresAttrSpec'] = IndyPresAttrSpec
    globals()['IndyPresPredSpec'] = IndyPresPredSpec


class IndyPresPreview(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'attributes': ([IndyPresAttrSpec],),  # noqa: E501
            'predicates': ([IndyPresPredSpec],),  # noqa: E501
            'type': (str,),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, attributes, predicates, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            type (str): Message type identifier. [optional]  # noqa: E501
        """
