...
class KeylistQuery(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'paginate': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            filter ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Query dictionary object. [optional]  # noqa: E501
            paginate ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Pagination info. [optional]  # noqa: E501
        """
