...
class Credential(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'credential_subject': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'issuance_date': (str,),  # noqa: E501
            'issuer': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'type': ([str],),  # noqa: E501
            'expiration_date': (str,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'proof': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'credential_subject': 'credentialSubject',  # noqa: E501
        'issuance_date': 'issuanceDate',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, context, credential_subject, issuance_date, issuer, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            expiration_date (str): The expiration date. [optional]  # noqa: E501
            id (str): [optional]  # noqa: E501
            proof ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The proof of the credential. [optional]  # noqa: E501
        """
