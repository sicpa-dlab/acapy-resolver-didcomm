...
class V20PresExRecord(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            pres ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Serialized presentation message. [optional]  # noqa: E501
            pres_ex_id (str): Presentation exchange identifier. [optional]  # noqa: E501
            pres_proposal ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Serialized presentation proposal message. [optional]  # noqa: E501
            pres_request ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Serialized presentation request message. [optional]  # noqa: E501
