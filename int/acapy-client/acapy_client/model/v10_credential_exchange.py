...
class V10CredentialExchange(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'credential': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'credential_definition_id': (str,),  # noqa: E501
            'credential_exchange_id': (str,),  # noqa: E501
            'credential_id': (str,),  # noqa: E501
            'credential_offer': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'credential_offer_dict': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'credential_proposal_dict': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'credential_request': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'credential_request_metadata': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'error_msg': (str,),  # noqa: E501
            'initiator': (str,),  # noqa: E501
            'parent_thread_id': (str,),  # noqa: E501
            'raw_credential': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            credential_offer_dict ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Serialized credential offer message. [optional]  # noqa: E501
            credential_proposal_dict ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Serialized credential proposal message. [optional]  # noqa: E501
            credential_request ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): (Indy) credential request. [optional]  # noqa: E501
            credential_request_metadata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): (Indy) credential request metadata. [optional]  # noqa: E501
