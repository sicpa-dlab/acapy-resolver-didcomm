    ...
    def __init__(self, api_client=None):
        ...
        def __send_basic_message(
            ...
            **kwargs
            ...
            >>> thread = api.send_basic_message(conn_id, async_req=True)
            >>> result = thread.get()
        ...
        self.send_basic_message = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [],
                'endpoint_path': '/connections/{conn_id}/send-message',
                'operation_id': 'send_basic_message',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
