    ...
    def __init__(self, api_client=None):
        ...
        def __start_introduction(
            ...
            **kwargs
            ...
            >>> thread = api.start_introduction(conn_id, target_connection_id, async_req=True)
            >>> result = thread.get()
            ...
            kwargs['conn_id'] = \
                conn_id
            kwargs['target_connection_id'] = \
                target_connection_id
            return self.call_with_http_info(**kwargs)

        self.start_introduction = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [],
                'endpoint_path': '/connections/{conn_id}/start-introduction',
                'operation_id': 'start_introduction',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
