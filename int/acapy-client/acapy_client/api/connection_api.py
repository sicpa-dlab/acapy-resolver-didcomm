...
class ConnectionApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.establish_inbound = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [],
                'endpoint_path': '/connections/{conn_id}/establish-inbound/{ref_id}',
                'operation_id': 'establish_inbound',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        def __get_endpoints(
            ...
            **kwargs
            ...
            >>> thread = api.get_endpoints(conn_id, async_req=True)
            >>> result = thread.get()
